...
<html class="loaded" lang="en" data-textdirection="ltr"><head>
    ...
    <title>TicketR REGISTRATION</title>
...
jQuery(function(){
   ...
   $.ajax({
     ...
     success : function(response) {
    	 ...
    	 var ss = '<option value="">Select your option</option><option value="'+name+'">No Follower</option>';
			 $.each(response, function(index) {
				 if(name==response[index].name ){}else{
					 	s += '<option value="' + response[index].name + '">' + response[index].name + '-'+response[index].role+'</option>';
					 }  
			/* 	 if(name==response[index].name ){}else{
					 	ss += '<option value="' + response[index].name + '">' + response[index].name + '-'+response[index].role+'</option>';
					 } */
				 });
			  $("#to").html(s);
			 // $("#follower").html(ss);

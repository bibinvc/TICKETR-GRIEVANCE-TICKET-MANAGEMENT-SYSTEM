...
<html class="loaded" lang="en" data-textdirection="ltr"><head>
    ...
    <meta name="author" content="ticketR">
    <title>:ticketR SUPER ADMIN DASHBOARD</title>
    ...
    <div class="main-menu menu-fixed menu-dark menu-accordion    menu-shadow " data-scroll-to-active="true">
      <div class="main-menu-content ps-container ps-theme-light ps-active-y" data-ps-id="7e2bc806-372e-778a-7b1e-09f9b92a0646">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
           ...
           <li class="active nav-item"><a href="/auth/ticketdash"><span class="menu-title" data-i18n="nav.support_raise_support.main">Dashboard</span></a>
           ...
           <li class="nav-item"><a href="/auth/ticketinbox"></i><span class="menu-title" data-i18n="nav.support_raise_support.main">My Inbox</span></a>
...
<%}%>
						 ...
						 $.each(response, function(index) {
							  ...
							  $("div#replay").show();
							    $("div#replay").show().attr("id");
								  ...
								  out+= " : </b><label>"+response[index].msg+"</label></h5>";
								  }
						    });
    ...
    <a class="customizer-toggle bg-danger box-shadow-3" href="#">
        <img class="brand-logo" src="/img/ticket.png">
    </a>
	...
	<h4 class="text-uppercase mb-0">Remarks<strong id="ticketid2"></strong></h4>
	<hr>
	<h5 class="mt-1 mb-1 text-bold-500"><b><label id="remarks"></label></b></h5>
	...
	<div id="replay">
	 <form method="post" action="/auth/supertaskcomplete" enctype="multipart/form-data" id="myform"> 
...
<div class="ps-scrollbar-x-rail" style="left: 0px; bottom: 3px;"><div class="ps-scrollbar-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps-scrollbar-y-rail" style="top: 0px; height: 643px; right: 3px;"><div class="ps-scrollbar-y" tabindex="0" style="top: 0px; height: 511px;"></div></div></div>
    ...
    <a href="/auth/newtaskreg"  class="btn bg-gradient-directional-blue white btn-blue btn-glow px-2">New Task</a>
    </div>

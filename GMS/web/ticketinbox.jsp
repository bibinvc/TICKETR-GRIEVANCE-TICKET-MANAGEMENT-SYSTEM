    ...
    <div class="main-menu menu-fixed menu-dark menu-accordion    menu-shadow " data-scroll-to-active="true">
      <div class="main-menu-content ps-container ps-theme-light ps-active-y" data-ps-id="7e2bc806-372e-778a-7b1e-09f9b92a0646">
         <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
           ...
           <li class="active nav-item"><a href="/auth/ticketinbox"><i class="icon-support"></i><span class="menu-title" data-i18n="nav.support_raise_support.main">My Inbox</span></a>
...
<p><b>Priority :</b> <%=row.get("priority") %> 	|	<b>Remarks :</b> <%=row.get("title") %> </p><p><b>Due Date / Time : </b><%=row.get("title") %> 	|	<%=row.get("reqdate") %>  /  <%=row.get("reqtime") %> </p>

<p><b>Status :</b> <%=row.get("status") %> </p>

    ...
    <div class="main-menu menu-fixed menu-dark menu-accordion    menu-shadow " data-scroll-to-active="true">
      <div class="main-menu-content ps-container ps-theme-light ps-active-y" data-ps-id="7e2bc806-372e-778a-7b1e-09f9b92a0646">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
         ...
         <li class=" navigation-header"><span data-i18n="nav.category.layouts">My Menu</span><i class="ft-more-horizontal ft-minus" data-toggle="tooltip" data-placement="right" data-original-title="Layouts"></i>
          </li>
          
          <li class=" nav-item"><a href="/auth/newtaskreg"></i><span class="menu-title" data-i18n="nav.support_raise_support.main">New Task</span></a>
          
          <li class=" nav-item"><a href="/auth/ticketuserregister"></i><span class="menu-title" data-i18n="nav.support_raise_support.main">User Register</span></a>
...
<div class="card-content collapse show">
	                <div class="card-body">
	                    ...
	                    <form class="form form-horizontal row-separator" method="post" id="myForm" action="/auth/taskregisteration" enctype="multipart/form-data">
	                    
	                    <input type="hidden"  name="from" value="<%=name%>"/>
	                    
	                    	<div class="form-body">
	                    		<h4 class="form-section"><i class="fa fa-eye"></i> Task Registration</h4>
	                    		 
		                        <div class="row">
		                        	<div class="col-md-6">
			                        	<div class="form-group row last">
				                        	<label class="col-md-3 label-control" for="userinput3">Taks Title</label>
				                        	<div class="col-md-9">
				                            	<input type="text" id="title" class="form-control border-primary" placeholder="Taks Title" name="title">
			                        		</div>
			                       		</div>
			                       	</div>
			                       	<div class="col-md-6">
				                        <div class="form-group row last">
				                        	<label class="col-md-3 label-control" for="userinput4">Nature Of Work</label>
				                        	<div class="col-md-9">
				                            	<input type="text" id="nature" class="form-control border-primary" placeholder="Nature Of Work" name="natureofwork">
			                        		</div>
				                        </div>
				                    </div>
		                        </div>
		                        <div class="row">
		                        	<div class="col-md-6">
			                        	<div class="form-group row last">
				                        	<label class="col-md-3 label-control" for="userinput3">Type Of Support</label>
				                        	<div class="col-md-9">
				                            	<input type="text" id="type" class="form-control border-primary" placeholder="Type Of Support" name="typeofsupport">
			                        		</div>
			                       		</div>
			                       	</div>
			                       	<div class="col-md-6">
				                        <div class="form-group row last">
				                        	<label class="col-md-3 label-control" for="userinput4">Assigned To</label>
				                        	<div class="col-md-9">
				                        	<select id="to" name="to" class="form-control border-primary">
			                                <option value="none" selected="" disabled="">Select Deportment</option>
			                                
			                                <option value="Rush">Rush</option>
			                                
			                            </select>
				                            	<!-- <input type="text" id="userinput4" class="form-control border-primary" placeholder="Assigned To" name="to"> -->
			                        		</div>
				                        </div>
				                    </div>
		                        </div>
		                         ...
		                         <div class="row">
		                        	<div class="col-md-6">
			                        	<div class="form-group row last">
				                        	<label class="col-md-3 label-control" for="userinput3">Follower</label>
				                        	<div class="col-md-9">
				                        	<select id="follower"  name="follower" class="form-control border-primary">
			                                <option value="none" selected="" disabled="">Select Deportment</option>
			                             
			                            </select>
			                            
				                            	<!-- <input type="text" id="userinput3" class="form-control border-primary" placeholder="Follower" name="follower"> -->
			                        		</div>
			                       		</div>
			                       	</div>
			                       	<div class="col-md-6">
				                        <div class="form-group row last">
				                        	<label class="col-md-3 label-control" for="userinput4">Priority</label>
				                        	<div class="col-md-9">
				                        	<select id="priority" name="priority" class="form-control border-primary">
			                                <option value="none" selected="" disabled="">Select Deportment</option>
			                                <option value="Rush">Rush</option>
			                                <option value="Normal">Normal</option>
			                                <option value="Super Rush">Super Rush</option>
			                            </select>
<!-- 				                            	<input type="text" id="userinput4" class="form-control border-primary" placeholder="Priority" name="priority"> -->
			                        		</div>
				                        </div>
				                    </div>
		                        </div>
		                         ...
		                         <!-- <div class="row">
		                        	<div class="col-md-6">
			                        	<div class="form-group row last">
				                        	<label class="col-md-3 label-control" for="userinput3">Due Date</label>
				                        	<div class="col-md-9">
				                            	<input type="text" id="due" class="form-control border-primary" placeholder="Due Date" name="duedate">
			                        		</div>
			                       		</div>
			                       	</div>
			                       	<div class="col-md-6">
				                        <div class="form-group row">
			                             ...
			                             <select id="dept" name="dept" class="form-control border-primary">
			                                <option value="none" selected="" disabled="">Select Deportment</option>
			                                <option value="CS">CS</option>
			                                <option value="Digitizing">Digitizing</option>
			                                <option value="SewOut">SewOut</option>
			                                ...
			                                <option value="WEB">WEB</option>
												...
												<input class="form-control border-primary" type="text" placeholder="Deportment" id="userinput6">
											</div>
										</div>
				                    </div>
		                        </div> -->

		                        <h4 class="form-section"><i class="fa fa-envelope"></i> Other Information</h4>
		                        ...
		                        <div class="row">
		                        	...
		                        	<div class="form-group row last">
				                        	<label class="col-md-3 label-control" for="userinput4">File Attachment</label>
				                        	<div class="col-md-9">
				                            	<input type="file" id="files" class="form-control border-primary" placeholder="File Attachment" name="file" multiple="multiple">
			                        		</div>
				                        </div>
		                        	...
		                        	<div class="col-md-6">
		                        		<div class="form-group row last">
				                        	<label class="col-md-3 label-control" for="userinput8">Remarks</label>
				                        	<div class="col-md-9">
				                            	<textarea id="remarks" rows="6" class="form-control border-primary" name="remark" placeholder="Your messages"></textarea>
				                           	</div>
				                        </div>
		                        	</div>
		                        </div>
	...
	<h4 class="text-uppercase mb-0">Ticket_Id: #<strong id="ticketid2">1245</strong></h4>
	<hr>
...
jQuery(function(){
    ...
    $("#savebtn").click(function(){
    	...
    	if($("#title").val()==""){
    		alert('Enter your taks.');
    		$("#title").focus();
    		return false;
    	}
    	if($("#nature").val()==""){
			alert('Enter your natur of work.');
			$("#nature").focus();
			return false;	
		    	}
		if($("#type").val()==""){
			alert('Enter the type of supports.');
			$("#type").focus();
			return false;	
		    	}
		if($("#to").val()==""){
			alert('Select to the users.');
			$("#to").focus();
			return false;	
		    	}
		if($("#follower").val()==""){
			alert('Select the follower.');
			$("#follower").focus();
			return false;	
		    	}
		if($("#priority").val()==""){
			alert('Select your task priority.');
			$("#priority").focus();
			return false;	
		    	}
		if($("#due").val()==""){
			alert('Enter your taks due.');
			$("#due").focus();
			return false;	
		    	}
		/* if($("#dept").val()==""){
			alert('Select to the user deporrment .');
			$("#dept").focus();
			return false;	
		    	} */
		if($("#remarks").val()==""){
			alert('Enter if any remarks.');
			$("#remarks").focus();
			return false;	
		    	}
   ...
   $.ajax({
     ...
     success : function(response) {
    	 ...
    	 var s = '<option value="">Select your option</option>';
			 $.each(response, function(index) {
				 if(name==response[index].name){}else{
				 	s += '<option value="' + response[index].name + '">' + response[index].name + '-'+response[index].role+'</option>';
				 }
   ...
   $("#to").change(function(){
	      var fname = $("#to").val();
		     ...
		     success : function(response) {
		    	 ...
		    	 var s = '<option value="">Select your option</option><option value="'+name+'">No Follower</option>';
					 $.each(response, function(index) {
						 if(fname==response[index].name || name==response[index].name){}else{
						 	s += '<option value="' + response[index].name + '">' + response[index].name + '-'+response[index].role+'</option>';
						 }

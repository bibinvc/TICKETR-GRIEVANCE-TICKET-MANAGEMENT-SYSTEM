 ...
 */
@WebServlet("/auth/userticketinbox")
public class TicketInboxServ extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try
		{
			//String query = "select * from ticket_tbl where assigndto='"+name+"' order by id desc";
			String query = "select * from ticket_tbl where assigndto='"+name+"' || follower='"+name+"' ||requstuser='"+name+"' order by id desc";
            ...
            // response.setContentType("application/json");
              ...
              response.sendRedirect("/auth/usertaskinbox");

...
public class TicketDashServ extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try
		{
			String query = "select * from ticket_tbl where status='Processing' || status='Hold' order by id desc";																			
			...
			request.getRequestDispatcher("/auth/dashticket").forward(request, response);
